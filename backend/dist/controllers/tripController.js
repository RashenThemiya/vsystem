...
export const endTripController = async (req, res) => {
    try {
        const trip_id = parseInt(req.params.id);
...
export const addDamageCostController = async (req, res) => {
    try {
        const trip_id = parseInt(req.params.id);
...
export const addTripPaymentController = async (req, res) => {
    try {
        const trip_id = parseInt(req.params.id);
...
export const updateTripDatesController = async (req, res) => {
    try {
        const trip_id = parseInt(req.params.id);
        const data = req.body;
...
export const updateTripMeterController = async (req, res) => {
    try {
        const trip_id = parseInt(req.params.id);
