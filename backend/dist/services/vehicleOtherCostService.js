 ...
 */
export const createVehicleCostService = async (data) => {
    let bill_id;
 ...
 */
export const getVehicleCostByIdService = async (id) => {
 ...
 */
export const updateVehicleCostService = async (id, data) => {
    let billConnection;
    if (data.bill_id) {
 ...
 */
export const deleteVehicleCostService = async (id) => {
    await prisma.vehicle_Other_Cost.delete({
        where: { vehicle_other_cost_id: id },
    });
    return true;
};
//# sourceMappingURL=vehicleOtherCostService.js.map