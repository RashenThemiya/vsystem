...
// ----------------- HELPER - Upload to R2 -----------------
const uploadToR2 = async (base64Image, fileNamePrefix = "bill") => {
    if (!base64Image)
        return null;
...
export const updateBillService = async (id, data) => {
    ...
    const bill = await prisma.bill_Upload.update({
        ...
        data: {
            ...
            vehicle_other_cost: data.vehicle_other_cost_id !== undefined
...
//# sourceMappingURL=billUploadService.js.map