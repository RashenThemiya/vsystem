...
export const updateVehicleService = async (id: number, data: AnyObj) => {
  ...
  if (data.vehicle_number !== undefined) scalarUpdate.vehicle_number = String(data.vehicle_number);
  if (data.name !== undefined) scalarUpdate.name = String(data.name);
  if (data.type !== undefined) scalarUpdate.type = data.type;
  maybeSetNumber("rent_cost_daily");
  if (data.fuel_id !== undefined) scalarUpdate.fuel_id = Number(data.fuel_id);
  if (data.ac_type !== undefined) scalarUpdate.ac_type = data.ac_type;
  ...
  for (const f of imageFields) {
    if (data[f] !== undefined) scalarUpdate[f] = toBufferIfBase64(data[f]);
  }
  ...
  if (
    ...
    if (data.tracker_id !== undefined) gpsPayload.tracker_id = String(data.tracker_id);
    if (data.gps_latitude !== undefined) gpsPayload.latitude = Number(data.gps_latitude);
    if (data.gps_longitude !== undefined) gpsPayload.longitude = Number(data.gps_longitude);
  ...
  if (data.mileage_cost !== undefined || data.mileage_cost_additional !== undefined) {
    ...
    if (data.mileage_cost_additional !== undefined)
      mileagePayload.mileage_cost_additional = Number(data.mileage_cost_additional);
    ...
    if (existingMileage) {
      ...
      await prisma.mileage_Cost.create({
        data: {
          ...
          mileage_cost_additional: mileagePayload.mileage_cost_additional ?? 0,
        },
      });
    }
  }
