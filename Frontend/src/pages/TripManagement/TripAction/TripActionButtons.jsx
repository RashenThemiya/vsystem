...
const TripActionButtons = ({
  ...
  const simpleButtonStyle =
    "px-4 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700 transition duration-200";
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <button onClick={onAlterReturnDate} className={simpleButtonStyle}>
        Alter Leave/Return Date
      </button>

      <button onClick={onAlterMeter} className={simpleButtonStyle}>
