...
export default function ActionCards({ onAddOwnerClick }) {
      ...
      <div className="bg-white p-5 rounded-xl shadow flex flex-col justify-between h-full">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-lg bg-blue-50">
            <PlusCircle onClick={onAddOwnerClick} className="text-blue-600" />
          </div>
          <div className="font-semibold">Add New Vehicle Owner</div>
        </div>

        <p className="text-sm text-gray-500 mt-3">
          Register a new Vehicle Owner to the system.
        </p>
      </div>
