...
export default function ActionCards({ onAddDriverClick }) {
      ...
      <div className="bg-white p-5 rounded-xl shadow flex flex-col justify-between h-full">
        <div className="flex items-center gap-3">
          <div className="p-3 rounded-lg bg-blue-50">
            <PlusCircle onClick={onAddDriverClick} className="text-blue-600" />
          </div>
          <div className="font-semibold">Add New Driver</div>
        </div>
