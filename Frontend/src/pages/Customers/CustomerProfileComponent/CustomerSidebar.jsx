...
const CustomerSidebar = ({ customer, openImage, refreshCustomer }) => {
  ...
  return (
    <div className="relative w-72 bg-gradient-to-r from-indigo-600 to-violet-700 
      ...
      <button
        onClick={() => navigate(-1)}
        className="absolute top-4 left-4 p-3 bg-gradient-to-r from-indigo-600 to-violet-700 
          text-white rounded-full shadow hover:bg-gray-600"
      >
