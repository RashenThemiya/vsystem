...
import { PlusCircle, Car, FileText } from "lucide-react";
      ...
      <div className="p-8 w-full overflow-auto bg-gray-50">
        ...
        <div className="text-3xl font-semibold mb-8">
          ...
          <p className="text-lg text-gray-500">
            Manage vehicles, their details, and related information
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-300">
            ...
            <p className="text-gray-700 mb-4">
              Generate and view detailed vehicle usage and maintenance reports.
            </p>
            <button
